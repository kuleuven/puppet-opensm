(*
Module: OpenSM, based on Simplevars
...
(* View: entry *)
let entry = Build.key_value Rx.word Sep.space
...
(* Variable: filter *)
let filter = incl "/etc/rdma/opensm.conf"
           . incl "/etc/rdma/opensm.conf.*"
           . incl "/etc/opensm/opensm.conf"
